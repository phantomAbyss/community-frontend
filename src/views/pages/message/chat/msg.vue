    ...
    <div class="dialog">
      ...
      <div class="chat-head">
        <div class="head-content">
          <span>
            <a href="#" target="_blank"> phantom </a>
          </span>
          <div class="head-oprt">
            <el-popover
      ...
      <div class="chat-body">
        <div class="chat-item fill-bg my-reply">
          <a href="#" target="_blank" class="chat-head">
            <img
              src="http://localhost:8080/img/avatar.89779596.jpg"
              alt="用户的头像"
            />
          </a>
          <div class="tooltip">
            ...
            <div class="msg-info">
              <span>2021年1月29日 15:16</span>
              <a href="javascript:void(0);">删除</a>
            </div>
          </div>
        </div>
        <div class="chat-item fill-bg">
          <a href="#" target="_blank" class="chat-head">
            <img
              src="http://localhost:8080/img/avatar.89779596.jpg"
              alt="用户的头像"
      ...
      .my-reply {
        ...
        .tooltip {
          ...
          .tooltip-arrow {
            ...
            border-width: 5px 10px;
            border-color: transparent transparent transparent #8d8dfc;
            right: -19px;
            left: auto;
          }
          .msg-chat {
